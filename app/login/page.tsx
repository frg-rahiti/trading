...
export default function Login(){
  ...
  async function submit(e:FormEvent){e.preventDefault();setMessage('Signing in…');const {error}=await createClient().auth.signInWithPassword({email,password});if(error){setMessage(error.message);return}window.location.href='/dashboard'}
